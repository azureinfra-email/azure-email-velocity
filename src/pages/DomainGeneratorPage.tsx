...
const DomainGeneratorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title={seoConfig.domainGenerator.title}
        description={seoConfig.domainGenerator.description}
        keywords={seoConfig.domainGenerator.keywords}
        canonical={seoConfig.domainGenerator.canonical}
        schemaType={seoConfig.domainGenerator.schemaType}
      />
