...
<table style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: ${fontSize}; line-height: 1.4; color: ${colors.text}; background-color: #F9FAFB;">
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title={seoConfig.emailSignatureGenerator.title}
        description={seoConfig.emailSignatureGenerator.description}
        keywords={seoConfig.emailSignatureGenerator.keywords}
